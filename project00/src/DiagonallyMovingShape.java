...
public class DiagonallyMovingShape extends Shape{
	public DiagonallyMovingShape(URL imgURL, int x, int y, int margin, int steps, int xBoundary, int yBoundary) {
		// imgPath : 그림 파일의 경로명
		// x, y : 이미지의 위치 좌표
	...
	public DiagonallyMovingShape(URL imgURL, int margin, int steps, int xBoundary, int yBoundary) {
